...
📦 Recurso: *${event.payload.resource_name}*
👤 Usuario ID: \`${event.payload.user_id}\`
📅 Fecha: ${new Date(event.payload.reserved_at).toLocaleString('es-ES')}
🆔 Reserva ID: \`${event.payload.reservation_id}\`
